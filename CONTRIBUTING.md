# Contributing to antigravity-starter
...
1. Check existing [Issues](https://github.com/andiupn/antigravity-starter/issues)
...
git clone https://github.com/andiupn/antigravity-starter.git
...
# 2. Setup environment
cp .env.example .env
# Fill in your GITHUB_TOKEN and database credentials

# 3. Setup agent permissions
cp .gemini/settings.local.example.json .gemini/settings.local.json
# Adapt permissions to your local environment
...
- Run standard TypeScript/lint checks: `npm run build` or `npx tsc`
- Verify component rendering and responsive design in your browser
- Verify `.gemini` settings are loaded by the AI assistant
...
If antigravity-starter helps you, consider:
...
- 💬 Ask in [Issues](https://github.com/andiupn/antigravity-starter/issues)
